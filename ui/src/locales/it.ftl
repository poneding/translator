...
tray-open-main = Schermata principale
tray-open-settings = Impostazioni
tray-check-update = Controlla aggiornamenti
...
settings-update-restart = Riavvia
...
main-synonyms = Sinonimi
main-antonyms = Antonimi
