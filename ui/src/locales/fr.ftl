...
tray-open-main = Accueil
tray-open-settings = Réglages
tray-check-update = Rechercher des mises à jour
...
settings-update-restart = Redémarrer
...
main-synonyms = Synonymes
main-antonyms = Antonymes
main-collocation = Collocation
main-etymology = Étymologie
main-alternatives = Alternatives
main-open-link = Ouvrir le lien
